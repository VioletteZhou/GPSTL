...
public abstract class SeleniumFunctions {
	...
	private static final int ELEMENT_WAIT_TIMEOUT_IN_SECONDS = 20;
	...
	public void takeScreenshot(String testName) {
		...
		try {
			...
			File yourFile = new File("C:\\Users\\Admin\\Desktop\\img\\"+testName+"_"+strDate+".png");
			yourFile.createNewFile();
			FileUtils.copyFile(scrFile, yourFile);
