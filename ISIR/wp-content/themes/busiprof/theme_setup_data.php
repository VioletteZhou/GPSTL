...
function theme_setup_data()
{
		...
		return $busiprof_theme_options = array(
			...
			'project_thumb_one' =>$template_uri .'/rec_project0.jpg', //project thumbnail one
			...
			'project_thumb_two' =>$template_uri .'/rec_project1.jpg', //project thumbnail two
			...
			'project_thumb_three' =>$template_uri .'/rec_project2.jpg', //project thumbnail three
			...
			'project_thumb_four' =>$template_uri .'/rec_project3.jpg', //project thumbnail three
