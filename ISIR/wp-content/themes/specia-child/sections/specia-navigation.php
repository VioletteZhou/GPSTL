	...
	<nav class='navbar navbar-default <?php echo specia_sticky_menu(); ?>' role='navigation'>
		...
		<div class="container">
			...
			<ul class="nav navbar-nav navbar-right">
				<li id=" menu-item-0 " class="menu-item menu-item-2"><a href="<?php echo get_permalink( $page1->ID ); ?>" title="Textes">Textes</a></li>
				...
				<li id=" menu-item-3 " class="menu-item menu-item-2"><a href="<?php echo get_permalink( $page4->ID ); ?>">Photos</a></li>
